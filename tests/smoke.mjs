...
const ROUTES = [
  ...
  ['/scripts/install-dod-certs.bat', 200, 'CAC.help'],
  ['/scripts/install-dod-certs.ps1', 200, 'BundleUrl'],
  ['/scripts/install-dod-certs.command', 200, 'CAC.help'],
  ['/scripts/install-dod-certs.sh', 200, 'BUNDLE_URL'],
  ['/library', 200, 'Issue Library'],
  ['/library/adobe-reader-dc-key-does-not-exist', 200, 'Adobe'],
